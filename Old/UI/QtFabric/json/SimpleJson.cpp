...
QString SimpleJson::encode(const QMap<QString,QVariant> &map)
{
...
QMap<QString, QVariant> SimpleJson::decode(const QString &jsonStr)
{
    QScriptValue object;
    QScriptEngine engine;
...
QScriptValue SimpleJson::encodeInner(const QMap<QString,QVariant> &map, QScriptEngine* engine)
{
...
QMap<QString, QVariant> SimpleJson::decodeInner(QScriptValue object)
{
...
QList<QVariant> SimpleJson::decodeInnerToList(QScriptValue arrayValue)
{
    QList<QVariant> list;
